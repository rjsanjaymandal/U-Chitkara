...
import AntHeroCarousel from "../Components/core/HomePage/AntHeroCarousel";
...
// Ant Design styles are automatically imported in Ant Design 5

function Home() {
  const [CatalogPageData, setCatalogPageData] = useState(null);
  const categoryID = "67fd4bfb9d406608104d81d1"; // Web Development category
          ...
          <div className="flex flex-row gap-5 mb-10 mt-[95px]">
            ...
            <div className="flex flex-col gap-10 w-[40%] items-start">
              <div className="text-[16px]">
                The modern Chitkara is the dictates its own terms. Today, to be
